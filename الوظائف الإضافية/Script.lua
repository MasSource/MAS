...
if redis:get(max.."getidstatus"..msg.chat_id_) == "Photo" then
	if data.photos_[0] then 
		...
		sendPhoto(msg.chat_id_,msg.id_,data.photos_[0].sizes_[1].photo_.persistent_id_,'- يُوزرك ❪ '..UserNameID..' ❫\n- ايديك ❪ '..msg.sender_user_id_..'❫\n- رتبتك ❪ '..msg.TheRank..' ❫\n- رسائلك ❪ '..msgs..' ❫\n➖')
		else
...
return '👨🏾‍🔧│ اصدار سورس فهاوه : *v'..version..'* \n📡'
end
...
local inline = {{{text="⚜│قناه السـورس ضـغـط هنا ",url="t.me/iull2"}}}
send_key(msg.sender_user_id_,'  [⚜│قناة سورس : فهاوه](t.me/iull2)',nil,inline,msg.id_)
return false
end
...
return [[
⠀
📨: مطور السورس : [Different](https://t.me/cdddd)
📨: قناة السورس : [ sᴏᴜʀᴄᴇ ᴍᴜᴛʙᴀʜɪ](https://t.me/jllln)
⠀⠀            ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
