...
return "\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\nالقوانين :\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n⚔ | إحترام مدراء وأدمنية المجموعة.\n⚔ | العنصرية بجميع أشكالها ممنوعة.\n⚔ | يمنع نشر المحتوى الإباحي بكل أنواعه.\n⚔ | يمنع التكلم بالأديان أو المذاهب أو السياسة.\n⚔ | يمنع نشر الحسابات الشخصية دون أخذ الموافقة.\n⚔ | يمنع نشر الإعلانات بكل أنواعها دون أخذ الموافقة.\n⚔ | يمنع السب أو التلفظ بألفاظ نابية او خادشة للحياء.\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ"
else 
...
if MsgText[2] == "قائمة الزواحف" then
if not msg.Rank then end
...
if MsgText[2] == "قائمة الكلاب" then
if not msg.Rank then end
...
if MsgText[2] == "قائمة الحمار" then
if not msg.Rank then end
...
if MsgText[2] == "قائمة القرود" then
if not msg.Rank then end
...
if MsgText[2] == "قائمة الذبان" then
if not msg.Rank then end
...
if MsgText[2] == "قائمة الكليجه" then
if not msg.Rank then end
...
local inline = {{{text="⚜│قناه السـورس ضـغـط هنا ",url="t.me/MasSource"}}}
send_key(msg.sender_user_id_,'  [⚜│قناة سورس : ماس](t.me/MasSource)',nil,inline,msg.id_)
return false
end
...
sendMsg(msg.chat_id_,msg.id_,"♦️| اهلا عزيزي تم مسح قائمة الاوامر")
end
if Black == "قائمة الاوامر" then
if not msg.Kara then return "♦️*│*هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n💥" end
local CmDlist = redis:smembers(max..'CmDlist:'..msg.chat_id_)
local t = '♦️| قائمة الاوامر : \n'
...
🤖  أهلاً أنا بوت وإسمي   []]..redis:get(max..':NameBot:')..[[] 🤖

ــــــــــــــــــــــــــــــــــــــــــــــــــــــــ
إختصاصي :


المساعدة على إدارة المجموعات وحمايتها من السبام والتوجيه والتكرار الخ..    
ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ
لتفعيل البوت اتبع ما يلي :

1- أضف البوت إلى المجموعة الخاصة بك.
2- إرفع البوت مشرف في المجموعة.
3- تحويل سجل المحادثة للأعضاء الجدد إلى ظاهر.
4- أرسل تفعيل في المجموعة وسيتم تفعيل البوت بنجاح.
ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ
🙋🏻‍♂️│ معرف الـمـطـور : ]]..SUDO_USER..[[
]]
else
text = [[ 
ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ
...
if welcome then
rules = (redis:get(max..'rulse:msg'..msg.chat_id_) or "ــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\nالقوانين :\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n⚔ | إحترام مدراء وأدمنية المجموعة.\n⚔ | العنصرية بجميع أشكالها ممنوعة.\n⚔ | يمنع نشر المحتوى الإباحي بكل أنواعه.\n⚔ | يمنع التكلم بالأديان أو المذاهب أو السياسة.\n⚔ | يمنع نشر الحسابات الشخصية دون أخذ الموافقة.\n⚔ | يمنع نشر الإعلانات بكل أنواعها دون أخذ الموافقة.\n⚔ | يمنع السب أو التلفظ بألفاظ نابية او خادشة للحياء.\nــــــــــــــــــــــــــــــــــــــــــــــــــــــــ")
